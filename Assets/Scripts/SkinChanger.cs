...
public class SkinChanger : MonoBehaviour 
{
	...
	public int ChangeMaterial(int toMat)
	{
		if (toMat < 0)
		{
			mesh.sharedMaterials = new Material[]{mats[mats.Length - 1], mesh.materials[1]};
			return mats.Length - 1;
		}
		else if (toMat > mats.Length - 1)
		{
			mesh.sharedMaterials = new Material[]{mats[0], mesh.materials[1]};
			return 0;
		}
		else
		{
			mesh.sharedMaterials = new Material[]{mats[toMat], mesh.materials[1]};
			return toMat;
		}
	}
